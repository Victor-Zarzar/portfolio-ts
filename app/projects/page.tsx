  ...
  return (
    <div className="col-span-4 mx-auto">
      ...
      <div className="px-10 my-4 mt-20" id="projects">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-y-10 gap-10 md:gap-16 lg:gap-24 xl:gap-20 p-10">
            ...
            <div key={index} className="relative">
              <div className="flex flex-col shadow-sm h-[26rem] w-auto md:h-[28rem] md:w-auto lg:h-[28rem] lg:w-auto bg-gray-800 p-8 rounded-2xl">
                <a href={sourceCodeLinks[index]} target="_blank" rel="noreferrer" className="mb-4">
                  <Image src={project.photo} alt={project.title} width={350} height={200} priority className='mx-auto h-[10rem] w-[20rem] md:h-[12rem] md:w-[25rem] lg:h-[12rem] lg:w-[20rem]' />
                </a>
